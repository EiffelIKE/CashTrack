...
import { CurrencyAbreviation, CurrencyWithDenominationAmounts } from '@/types/currency';
...
const currenciesSlice = createSlice({
  ...
  reducers: {
    ...
    setAddActiveCurrency(state, action: {payload: CurrencyWithDenominationAmounts}) {
...
export const { setCurrencies, setDeleteActiveCurrency, setAddActiveCurrency } = currenciesSlice.actions;

export const selectAvailableCurrencies = (state: RootState) => state.availableCurrencies.currencies
export const selectActiveCurrencies = (state: RootState) => state.availableCurrencies.activeCurrencies
